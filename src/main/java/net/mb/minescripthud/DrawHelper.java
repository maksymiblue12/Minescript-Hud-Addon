...
public class DrawHelper {
	...
	public static class TextObject extends Layered {
		...
		public boolean containsPoint(double x, double y) {
			...
			Vector2f bottomRight=new Vector2f((float)this.x+Minecraft.getInstance().font.width(this.text),(float)this.y+Minecraft.getInstance().font.lineHeight);
		...
		@Override
		Matrix3x2f createMatrix(double scale_x, double scale_y, double rotation, double diff_x, double diff_y) {
			return DrawHelper.createMatrix(x,y,Minecraft.getInstance().font.width(text),Minecraft.getInstance().font.lineHeight,scale_x,scale_y,rotation,diff_x,diff_y);
		}
	}
	...
	public static class StrokedRectangleObject extends Layered {
		...
		@Override
		public Jsonable toJsonable() {
			return new JsonableStrokedRectangleObject(this);
		}

		@Override
		public String getObjectType() {
			return "stroked_rectangle";
		}
	}
	...
	public static class TextWithBackgroundObject extends Layered {
		...
		public boolean containsPoint(double x, double y) {
			...
			Vector2f bottomRight=new Vector2f((float)this.x+Minecraft.getInstance().font.width(this.text)-1+this.marginX,(float)this.y+Minecraft.getInstance().font.lineHeight-2+this.marginY);
			inverse.transformPosition(point);
			return topLeft.x<=point.x && point.x<=bottomRight.x && topLeft.y<=point.y && point.y<=bottomRight.y;
		}
		...
		@Override
		Matrix3x2f createMatrix(double scale_x, double scale_y, double rotation, double diff_x, double diff_y) {
			return DrawHelper.createMatrix(this.x,this.y,Minecraft.getInstance().font.width(this.text),Minecraft.getInstance().font.lineHeight,scale_x,scale_y,rotation,diff_x,diff_y);
		}
	}
	...
	public static class ShapeObject extends Layered {
		...
		@Override
		Matrix3x2f createMatrix(double scale_x, double scale_y, double rotation, double diff_x, double diff_y) {
			return DrawHelper.createMatrix(bounds.left(),bounds.top(),bounds.width(),bounds.height(),scale_x,scale_y,rotation,diff_x,diff_y);
		}
	}
}
