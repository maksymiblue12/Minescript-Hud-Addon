...
public class MouseTracker {
	...
	public void update() {
		...
		boolean left=GLFW.glfwGetMouseButton(window.getHandle(),InputUtil.GLFW_MOUSE_BUTTON_LEFT)==InputUtil.GLFW_PRESS;
		leftClicked=left&&!isLeftDown;
		isLeftDown=left;

		boolean middle=GLFW.glfwGetMouseButton(window.getHandle(),InputUtil.GLFW_MOUSE_BUTTON_MIDDLE)==InputUtil.GLFW_PRESS;
		middleClicked=middle&&!isMiddleDown;
		isMiddleDown=middle;

		boolean right=GLFW.glfwGetMouseButton(window.getHandle(),InputUtil.GLFW_MOUSE_BUTTON_RIGHT)==InputUtil.GLFW_PRESS;
